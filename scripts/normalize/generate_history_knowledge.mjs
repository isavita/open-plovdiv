...
const notablePersonRecords = notablePeople
  .map((person) => {
    ...
    return {
      ...
      image: person.portrait?.url ?? null,
      image_credit: person.portrait?.credit ?? null,
      image_page_url: person.portrait?.page_url ?? null,
      image_license: person.portrait?.license ?? null,
      image_license_url: person.portrait?.license_url ?? null,
      image_accessed_at: person.portrait?.accessed_at ?? null,
      term_events: [],
      event_ids: [],
      place_ids: [],
      organization_ids: [],
