...
const labelTable = {
  ...
  summerTitle: tr(
    ...
    "Plovdiv beyond the midday heat",
    "Plovdiv abseits der Mittagshitze",
    "Plovdiv loin de la chaleur de midi",
    "Plovdiv lontano dal caldo di mezzogiorno",
    "Öğle sıcağı dışında Plovdiv",
    "Plovdiv sin el calor del mediodía",
    "Το Πλόβντιβ μακριά από τη μεσημεριανή ζέστη",
    "真昼の暑さを避けるプロヴディフ",
  ...
  summerLead: tr(
    ...
    "Three smarter choices for a hot day: cool museums, shaded gardens or the hills at sunset. Carry water and avoid exposed hilltops at midday.",
    "Drei klügere Optionen für heiße Tage: kühle Museen, schattige Gärten oder die Hügel bei Sonnenuntergang. Wasser mitnehmen und offene Hügel mittags meiden.",
    "Trois choix plus adaptés aux fortes chaleurs : musées frais, jardins ombragés ou collines au coucher du soleil. Emportez de l'eau et évitez les sommets à midi.",
    "Tre scelte più adatte alle giornate calde: musei freschi, giardini ombreggiati o colline al tramonto. Portate acqua ed evitate le cime esposte a mezzogiorno.",
    "Sıcak bir gün için üç akıllı seçenek: serin müzeler, gölgeli bahçeler veya gün batımında tepeler. Su taşıyın ve öğle saatlerinde açık tepelerden kaçının.",
    "Tres opciones más sensatas para un día caluroso: museos frescos, jardines con sombra o colinas al atardecer. Lleve agua y evite las cimas expuestas al mediodía.",
    "Τρεις πιο έξυπνες επιλογές για ζεστή μέρα: δροσερά μουσεία, σκιεροί κήποι ή λόφοι στο ηλιοβασίλεμα. Έχετε νερό και αποφύγετε τις εκτεθειμένες κορυφές το μεσημέρι.",
